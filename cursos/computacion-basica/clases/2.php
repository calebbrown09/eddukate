...
<head>
     <meta charset="utf-8">
    <title><?php echo $titlo_curso_cb_ep2; ?></title>
...
<body style="background: #222831;">
      ...
      <section id="video-livestream">
       ...
       <br>
        ...
        <div class="description-live">
            <h1 style="color: white; font-size: 20px;"><?php echo $titlo_curso_cb_ep2; ?></h1>
      ...
      <script src="http://localhost:8888/eddukate/app/helpers/sponsor/js/count.js"></script>
